package br.com.strack.springboot_study.unittests.mapper;
...
public class ObjectMapperTests {
    br.com.strack.springboot_study.unittests.mocks.MockPerson inputObject;
    ...
    public void parseEntityListToDTOListTest() {
        List<PersonDTO> outputList = parseObjectsList(inputObject.mockEntityList(), PersonDTO.class);
    ...
    public void parserDTOListToEntityListTest() {
        List<Person> outputList = parseObjectsList(inputObject.mockDTOList(), Person.class);
